...
class CompanyRepositoryImpl @Inject constructor(
    ...
    override suspend fun postCompanyLogo(logo: ByteArray): Response<Void?> {
        val requestFile = RequestBody.create(MediaType.parse("application/octet-stream"), logo)
    ...
    override suspend fun postCompanyBanner(banner: ByteArray): Response<Void?> {
        val requestFile = RequestBody.create(MediaType.parse("application/octet-stream"), banner)
